...
export default function Intro1() {
    ...
    return (
        <SafeAreaView style={[style.area, { backgroundColor: Colors.bg, }]}>
            ...
            <ImageBackground source={require('../../../assets/image/img.png')} resizeMode='stretch' style={{ flex: 1, justifyContent: 'space-between', paddingVertical: 50 }}>

                <View style={{ marginHorizontal: 20, marginTop: 20 }}>
                    <Text style={[style.title, { color: Colors.active }]}>New designs everyday</Text>
