...
export default function HDetail() {
                ...
                <View style={[style.main, { backgroundColor: Colors.bg, marginTop: Platform.OS === 'ios' ? 10 : 30 }]}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} style={{ marginTop: 10 }}>
                        ...
                        <View style={{ padding: 15, backgroundColor: Colors.bord, borderRadius: 15 }}>
                            ...
                            <Image source={require('../../../assets/image/s13.png')} resizeMode='stretch' style={{ height: height / 3.5, width: width / 1.5, alignSelf: 'center', marginTop: -40 }} />
                            ...
                            <View style={[style.icon, { height: 25, width: 25, backgroundColor: '#F1DAE0' }]}></View>
                        ...
                        <Text style={[style.apptitle, { color: Colors.active, marginTop: 10 }]}>Croosa</Text>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <Text style={[style.r12, { color: Colors.active }]}>$23.00</Text>
                            <Text style={[style.r12, { color: Colors.disable, marginLeft: 15, textDecorationLine: 'line-through' }]}>$50.00</Text>
                        </View>
