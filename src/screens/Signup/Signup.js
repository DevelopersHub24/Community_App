        ...
        <SafeAreaView style={[style.area, { backgroundColor: Colors.bg }]}>
            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : null}>
                <View style={[style.main, { backgroundColor: Colors.bg, marginTop: Platform.OS === 'ios' ? 10 : 30 }]}>
                    ...
                    />
                    <Text style={[style.subtitle, { color: Colors.active ,marginTop:20}]}>Create your arino account</Text>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} style={{ marginTop: 10 }}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('Congrates')}
                            style={[style.btn, { marginTop: 40 }]}>
                            <Text style={[style.btntxt, { marginBottom: -4 }]}>Sign Up</Text>
                        </TouchableOpacity>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginVertical: 20, justifyContent: 'center', marginTop: 50 }}>
                            ...
                            <TouchableOpacity onPress={() => navigation.navigate('Login')}>
                                <Text style={[style.m12, { color: Colors.txt, textAlign: 'center' }]}> Sign In</Text>
                            </TouchableOpacity>
                        </View>
